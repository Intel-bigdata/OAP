...
You can use a pre-built JAR package to get started, it can be downloaded from [here]https://github.com/Intel-bigdata/OAP/releases/download/v0.9.0-spark-3.0.0/oap-0.9.0-bin-spark-3.0.0.tar.gz).
