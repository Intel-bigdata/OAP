...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code spinachRefreshIndices}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpinachRefreshIndices(SqlBaseParser.SpinachRefreshIndicesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code spinachCreateIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpinachCreateIndex(SqlBaseParser.SpinachCreateIndexContext ctx);
	/**
	 * Visit a parse tree produced by the {@code spinachDropIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpinachDropIndex(SqlBaseParser.SpinachDropIndexContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#indexCols}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIndexCols(SqlBaseParser.IndexColsContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#indexCol}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIndexCol(SqlBaseParser.IndexColContext ctx);
	/**
