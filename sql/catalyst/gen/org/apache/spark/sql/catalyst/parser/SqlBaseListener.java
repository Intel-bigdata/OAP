...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code spinachRefreshIndices}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterSpinachRefreshIndices(SqlBaseParser.SpinachRefreshIndicesContext ctx);
	/**
	 * Exit a parse tree produced by the {@code spinachRefreshIndices}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitSpinachRefreshIndices(SqlBaseParser.SpinachRefreshIndicesContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code spinachCreateIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterSpinachCreateIndex(SqlBaseParser.SpinachCreateIndexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code spinachCreateIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitSpinachCreateIndex(SqlBaseParser.SpinachCreateIndexContext ctx);
	/**
	 * Enter a parse tree produced by the {@code spinachDropIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterSpinachDropIndex(SqlBaseParser.SpinachDropIndexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code spinachDropIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitSpinachDropIndex(SqlBaseParser.SpinachDropIndexContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#indexCols}.
	 * @param ctx the parse tree
	 */
	void enterIndexCols(SqlBaseParser.IndexColsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#indexCols}.
	 * @param ctx the parse tree
	 */
	void exitIndexCols(SqlBaseParser.IndexColsContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#indexCol}.
	 * @param ctx the parse tree
	 */
	void enterIndexCol(SqlBaseParser.IndexColContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#indexCol}.
	 * @param ctx the parse tree
	 */
	void exitIndexCol(SqlBaseParser.IndexColContext ctx);
	/**
