...
public class SColumnIOFactory {
     ...
     */
    public SMessageIO getColumnIO(MessageType requestedSchema, MessageType fileSchema) {
     ...
     * @return the corresponding serializing/deserializing structure
     */
    public SMessageIO getColumnIO(MessageType requestedSchema, MessageType fileSchema, boolean strict) {
     ...
     * @return the corresponding serializing/deserializing structure
     */
    public SMessageIO getColumnIO(MessageType schema) {
