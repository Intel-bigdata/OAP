...
trait ParquetVsOapVsOrcConfigSet extends BenchmarkConfigSelector{
  ...
  def allConfigurations: Seq[BenchmarkConfig] = Seq(
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      ...
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap cache enabled offheap 0.6")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
      .setSparkConf("spark.sql.oap.dataCache.use.fiberCache.ratio", "0.6"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap binary cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      ...
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap binary cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.binary.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index oap binary cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.binary.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
    ...
    new BenchmarkConfig()
      ...
      .setSparkConf("spark.sql.oap.mix.index.memory.manager", "offheap")
      .setSparkConf("spark.sql.oap.mix.index.cache.backend", "guava")
      .setSparkConf("spark.sql.oap.mix.data.memory.manager", "pm")
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index data cache guava/vmem separation enabled")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.sql.oap.mix.index.memory.manager", "offheap")
      .setSparkConf("spark.sql.oap.mix.index.cache.backend", "guava")
      .setSparkConf("spark.sql.oap.mix.data.memory.manager", "tmp")
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "vmem"),
    new BenchmarkConfig()
      ...
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/ index data binary cache guava/vmem separation enabled")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.orc.binary.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index oap cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index oap cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.orc.data.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
      ...
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("Orc w/o index oap binary cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "orc")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.orc.binary.cache.enable", "true")
      .setSparkConf("spark.sql.orc.copyBatchToSpark", "true")
    ...
    //      .setSparkConf("spark.sql.oap.oapfileformat.data.cache.enable", "true"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap cache enabled pm 0.6")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap binary cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap binary cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index oap binary cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled tmp")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      .setSparkConf("spark.oap.cache.strategy", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled offheap")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled pm")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      .setSparkConf("spark.oap.cache.strategy", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled vmem")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
    ...
    new BenchmarkConfig()
      ...
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index data cache guava/vmem separation enabled")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.index.data.cache.separation.enable", "true")
    ...
    new BenchmarkConfig()
      ...
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "guava"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/ index data binary cache guava/vmem separation enabled")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "true")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.index.data.cache.separation.enable", "true")
      ...
      .setSparkConf("spark.sql.oap.mix.data.cache.backend", "vmem"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled offheap with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
    ...
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled pm with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZ4"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled vmem with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZ4"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled offheap with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZ4"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled pm with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZ4"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled vmem with LZ4 cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZ4"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled offheap with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
    ...
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled pm with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZF"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled vmem with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZF"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled offheap with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZF"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled pm with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZF"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled vmem with LZF cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "LZF"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled offheap with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
    ...
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled pm with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "SNAPPY"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled vmem with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "SNAPPY"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled offheap with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "SNAPPY"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled pm with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "SNAPPY"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled vmem with SNAPPY cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "SNAPPY"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled offheap with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
    ...
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled pm with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "ZSTD"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap cache enabled vmem with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.data.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "ZSTD"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled offheap with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "offheap")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "ZSTD"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled pm with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "pm")
      ...
      .setSparkConf("spark.sql.oap.data.fiber.cache.compression.codec", "ZSTD"),
    new BenchmarkConfig()
      .setBenchmarkConfName("parquet w/o index oap binary cache enabled vmem with ZSTD cache compress")
      .setBenchmarkConf(BenchmarkConfig.FILE_FORMAT, "parquet")
      .setBenchmarkConf(BenchmarkConfig.INDEX_ENABLE, "false")
      .setSparkConf("spark.sql.oap.parquet.binary.cache.enable", "true")
      .setSparkConf("spark.sql.oap.fiberCache.memory.manager", "tmp")
