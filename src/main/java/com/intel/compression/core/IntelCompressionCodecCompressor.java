...
public class IntelCompressionCodecCompressor implements Compressor {
   ...
   */
  public IntelCompressionCodecCompressor(int level, int directBufferSize,
      IntelCompressionCodecJNI jni) {
    this.jni = jni;
  ...
  void setInputFromSavedData() {
    ...
    uncompressedDirectBuf.put(userBuf, userBufOff,
  ...
  public int compress(byte[] b, int off, int len) throws IOException {
    ...
    n = jni.compress(null, uncompressedDirectBuf, 0, uncompressedDirectBufLen,
        null, compressedDirectBuf, 0, directBufferSize);
    uncompressedDirectBufLen = 0;
    compressedDirectBuf.limit(n);
    uncompressedDirectBuf.clear(); // codec consumes all buffer input
